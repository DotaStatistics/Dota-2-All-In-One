...
class FontStyles {
  ...
  static TextStyle whiteTextBold() {
    return TextStyle(color: Colors.white70, fontWeight: FontWeight.bold);
  }

  static TextStyle whiteTextHeader() {
    return TextStyle(color: Colors.white70, fontSize: 22.0);
  }

  static TextStyle appBarMatchDetails() {
    return TextStyle(color: Colors.white70, fontSize: 15.0);
  }
