...
class HeroDetailsScreen extends StatefulWidget {
  ...
  HeroDetailsScreen(this.data, this.itemKey, this.dataAbilities, this.itemKeyAbilities);
  @override
    ...
    Widget attributeSection = Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildAttributes('assets/images/Intelligence_Icon.png', 'intelligence'),
        ],
      ),
    );
...
//          "http://cdn.dota2.com/apps/dota2/images/abilities/"+returnSkillName(abilityId)+"_lg.png",
          "http://cdn.dota2.com/apps/dota2/images/abilities/"+"faceless_void_time_dilation"+"_lg.png",
          height: 40,
          width: 40,
        ),
      ],
...
//    return data[itemKey]["stat"][attribute+"Base"].toString()+" + "+ data[itemKey]["stat"][attribute+"Gain"].toString() ;
    return (data[itemKey]["stat"][attribute+"Base"]+data[itemKey]["stat"][attribute+"Gain"]).toString() ;
