...
Map<String, Item> itemFromJson(String str) => Map.from(json.decode(str))
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
        ...
        isInNeuralNetwork: json["isInNeuralNetwork"] == null
            ? null
            : json["isInNeuralNetwork"],
        isFullItemHeroPurchaseItem: json["isFullItemHeroPurchaseItem"] == null
            ? null
            : json["isFullItemHeroPurchaseItem"],
        components: json["components"] == null
            ? null
            : List<Component>.from(
                json["components"].map((x) => Component.fromJson(x))),
        isSupportFullItem: json["isSupportFullItem"] == null
            ? null
            : json["isSupportFullItem"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "isInNeuralNetwork":
            isInNeuralNetwork == null ? null : isInNeuralNetwork,
        "isFullItemHeroPurchaseItem": isFullItemHeroPurchaseItem == null
            ? null
            : isFullItemHeroPurchaseItem,
        "components": components == null
            ? null
            : List<dynamic>.from(components.map((x) => x.toJson())),
        "isSupportFullItem":
            isSupportFullItem == null ? null : isSupportFullItem,
      };
}
...
class Stat {
  ...
  factory Stat.fromJson(Map<String, dynamic> json) => Stat(
        ...
        fightLevelRecap:
            json["fightLevelRecap"] == null ? null : json["fightLevelRecap"],
        ...
        manaCost: json["manaCost"] == null
            ? null
            : List<double>.from(json["manaCost"].map((x) => x)),
        sharedCooldown: json["sharedCooldown"] == null
            ? null
            : sharedCooldownValues.map[json["sharedCooldown"]],
        ...
        isPurchaseable:
            json["isPurchaseable"] == null ? null : json["isPurchaseable"],
        isSecretShop:
            json["isSecretShop"] == null ? null : json["isSecretShop"],
        ...
        isHideCharges:
            json["isHideCharges"] == null ? null : json["isHideCharges"],
        isRequiresCharges: json["isRequiresCharges"] == null
            ? null
            : json["isRequiresCharges"],
        isDisplayCharges:
            json["isDisplayCharges"] == null ? null : json["isDisplayCharges"],
        isSupport: json["isSupport"] == null ? null : json["isSupport"],
        isTempestDoubleClonable: json["isTempestDoubleClonable"] == null
            ? null
            : json["isTempestDoubleClonable"],
        stockMax: json["stockMax"] == null ? null : json["stockMax"],
        initialCharges:
            json["initialCharges"] == null ? null : json["initialCharges"],
        initialStock:
            json["initialStock"] == null ? null : json["initialStock"],
        stockTime: json["stockTime"] == null ? null : json["stockTime"],
        initialStockTime:
            json["initialStockTime"] == null ? null : json["initialStockTime"],
        isRecipe: json["isRecipe"] == null ? null : json["isRecipe"],
        needsComponents:
            json["needsComponents"] == null ? null : json["needsComponents"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "sharedCooldown": sharedCooldown == null
            ? null
            : sharedCooldownValues.reverse[sharedCooldown],
        ...
        "isRequiresCharges":
            isRequiresCharges == null ? null : isRequiresCharges,
        ...
        "isTempestDoubleClonable":
            isTempestDoubleClonable == null ? null : isTempestDoubleClonable,
