...
Map<String, DotaAbility> dotaAbilityFromJson(String str) =>
    Map.from(json.decode(str)).map(
        (k, v) => MapEntry<String, DotaAbility>(k, DotaAbility.fromJson(v)));

String dotaAbilityToJson(Map<String, DotaAbility> data) => json.encode(
...
class DotaAbility {
  ...
  factory DotaAbility.fromJson(Map<String, dynamic> json) => DotaAbility(
        ...
        drawMatchPage:
            json["drawMatchPage"] == null ? null : json["drawMatchPage"],
...
class Language {
  ...
  factory Language.fromJson(Map<String, dynamic> json) => Language(
        ...
        aghanimDescription: json["aghanimDescription"] == null
            ? null
            : json["aghanimDescription"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "aghanimDescription":
            aghanimDescription == null ? null : aghanimDescription,
      };
}
...
class Stat {
  ...
  factory Stat.fromJson(Map<String, dynamic> json) => Stat(
        ...
        unitTargetType:
            json["unitTargetType"] == null ? null : json["unitTargetType"],
        unitTargetTeam:
            json["unitTargetTeam"] == null ? null : json["unitTargetTeam"],
        unitTargetFlags:
            json["unitTargetFlags"] == null ? null : json["unitTargetFlags"],
        unitDamageType:
            json["unitDamageType"] == null ? null : json["unitDamageType"],
        spellImmunity:
            json["spellImmunity"] == null ? null : json["spellImmunity"],
        modifierSupportValue: json["modifierSupportValue"] == null
            ? null
            : json["modifierSupportValue"].toDouble(),
        modifierSupportBonus: json["modifierSupportBonus"] == null
            ? null
            : json["modifierSupportBonus"],
        isOnCastbar: json["isOnCastbar"] == null ? null : json["isOnCastbar"],
        isOnLearnbar:
            json["isOnLearnbar"] == null ? null : json["isOnLearnbar"],
        fightRecapLevel:
            json["fightRecapLevel"] == null ? null : json["fightRecapLevel"],
        isGrantedByScepter: json["isGrantedByScepter"] == null
            ? null
            : json["isGrantedByScepter"],
        hasScepterUpgrade: json["hasScepterUpgrade"] == null
            ? null
            : json["hasScepterUpgrade"],
        maxLevel: json["maxLevel"] == null ? null : json["maxLevel"],
        levelsBetweenUpgrade: json["levelsBetweenUpgrade"] == null
            ? null
            : json["levelsBetweenUpgrade"],
        requiredLevel:
            json["requiredLevel"] == null ? null : json["requiredLevel"],
        displayAdditionalHeroes: json["displayAdditionalHeroes"] == null
            ? null
            : json["displayAdditionalHeroes"],
        castRangeBuffer: json["castRangeBuffer"] == null
            ? null
            : List<int>.from(json["castRangeBuffer"].map((x) => x)),
        ...
        hotKeyOverride:
            json["hotKeyOverride"] == null ? null : json["hotKeyOverride"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "modifierSupportValue":
            modifierSupportValue == null ? null : modifierSupportValue,
        "modifierSupportBonus":
            modifierSupportBonus == null ? null : modifierSupportBonus,
        ...
        "isGrantedByScepter":
            isGrantedByScepter == null ? null : isGrantedByScepter,
        "hasScepterUpgrade":
            hasScepterUpgrade == null ? null : hasScepterUpgrade,
        "maxLevel": maxLevel == null ? null : maxLevel,
        "levelsBetweenUpgrade":
            levelsBetweenUpgrade == null ? null : levelsBetweenUpgrade,
        "requiredLevel": requiredLevel == null ? null : requiredLevel,
        "displayAdditionalHeroes":
            displayAdditionalHeroes == null ? null : displayAdditionalHeroes,
        "castRangeBuffer": castRangeBuffer == null
            ? null
            : List<dynamic>.from(castRangeBuffer.map((x) => x)),
