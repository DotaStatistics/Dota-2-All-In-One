...
MatchDetails matchDetailsFromJson(String str) =>
    MatchDetails.fromJson(json.decode(str)[0]);

String matchDetailsToJson(List<MatchDetails> data) =>
...
class MatchDetails {
  ...
  factory MatchDetails.fromJson(Map<String, dynamic> json) => MatchDetails(
        ...
        didRadiantWin:
            json["didRadiantWin"] == null ? null : json["didRadiantWin"],
        durationSeconds:
            json["durationSeconds"] == null ? null : json["durationSeconds"],
        startDateTime:
            json["startDateTime"] == null ? null : json["startDateTime"],
        clusterId: json["clusterId"] == null ? null : json["clusterId"],
        firstBloodTime:
            json["firstBloodTime"] == null ? null : json["firstBloodTime"],
        lobbyType: json["lobbyType"] == null ? null : json["lobbyType"],
        numHumanPlayers:
            json["numHumanPlayers"] == null ? null : json["numHumanPlayers"],
        ...
        parsedDateTime:
            json["parsedDateTime"] == null ? null : json["parsedDateTime"],
        gameVersionId:
...
class Player {
  ...
  factory Player.fromJson(Map<String, dynamic> json) => Player(
        ...
        leaverStatus:
            json["leaverStatus"] == null ? null : json["leaverStatus"],
        numLastHits: json["numLastHits"] == null ? null : json["numLastHits"],
        numDenies: json["numDenies"] == null ? null : json["numDenies"],
        goldPerMinute:
            json["goldPerMinute"] == null ? null : json["goldPerMinute"],
        experiencePerMinute: json["experiencePerMinute"] == null
            ? null
            : json["experiencePerMinute"],
        ...
        intentionalFeeding: json["intentionalFeeding"] == null
            ? null
            : json["intentionalFeeding"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "experiencePerMinute":
            experiencePerMinute == null ? null : experiencePerMinute,
        ...
        "intentionalFeeding":
            intentionalFeeding == null ? null : intentionalFeeding,
