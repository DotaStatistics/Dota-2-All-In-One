...
List<DotaMatch> recentMatchesResultsFromJson(String str) =>
    List<DotaMatch>.from(json.decode(str).map((x) => DotaMatch.fromJson(x)));

String recentMatchesResultsToJson(List<DotaMatch> data) =>
...
class Player {
  ...
  factory Player.fromMatchDetails(prefix0.Player player) =>
      Player(itemList: player.itemList);
}
