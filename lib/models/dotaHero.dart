...
Map<String, DotaHero> dotaHeroFromJson(String str) => Map.from(json.decode(str)).map((k, v) => MapEntry<String, DotaHero>(k, DotaHero.fromJson(v)));

String dotaHeroToJson(Map<String, DotaHero> data) => json.encode(Map.from(data).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())));
...
class DotaHero {
  ...
  factory DotaHero.fromJson(Map<String, dynamic> json) => DotaHero(
    ...
    talents: json["talents"] == null ? null : List<Talent>.from(json["talents"].map((x) => Talent.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "talents": talents == null ? null : List<dynamic>.from(talents.map((x) => x.toJson())),
...
class Stat {
  ...
  factory Stat.fromJson(Map<String, dynamic> json) => Stat(
    ...
    heroUnlockOrder: json["heroUnlockOrder"] == null ? null : json["heroUnlockOrder"],
    team: json["team"] == null ? null : json["team"],
    cmEnabled: json["cmEnabled"] == null ? null : json["cmEnabled"],
    newPlayerEnabled: json["newPlayerEnabled"] == null ? null : json["newPlayerEnabled"],
    attackType: json["attackType"] == null ? null : attackTypeValues.map[json["attackType"]],
    startingArmor: json["startingArmor"] == null ? null : json["startingArmor"].toDouble(),
    startingMagicArmor: json["startingMagicArmor"] == null ? null : json["startingMagicArmor"],
    startingDamageMin: json["startingDamageMin"] == null ? null : json["startingDamageMin"],
    startingDamageMax: json["startingDamageMax"] == null ? null : json["startingDamageMax"],
    attackRate: json["attackRate"] == null ? null : json["attackRate"].toDouble(),
    attackAnimationPoint: json["attackAnimationPoint"] == null ? null : json["attackAnimationPoint"].toDouble(),
    attackAcquisitionRange: json["attackAcquisitionRange"] == null ? null : json["attackAcquisitionRange"],
    attackRange: json["attackRange"] == null ? null : json["attackRange"],
    primaryAttribute: json["primaryAttribute"] == null ? null : primaryAttributeValues.map[json["primaryAttribute"]],
    heroPrimaryAttribute: json["heroPrimaryAttribute"] == null ? null : json["heroPrimaryAttribute"],
    strengthBase: json["strengthBase"] == null ? null : json["strengthBase"],
    strengthGain: json["strengthGain"] == null ? null : json["strengthGain"].toDouble(),
    intelligenceBase: json["intelligenceBase"] == null ? null : json["intelligenceBase"],
    intelligenceGain: json["intelligenceGain"] == null ? null : json["intelligenceGain"].toDouble(),
    agilityBase: json["agilityBase"] == null ? null : json["agilityBase"],
    agilityGain: json["agilityGain"] == null ? null : json["agilityGain"].toDouble(),
    ...
    moveTurnRate: json["moveTurnRate"] == null ? null : json["moveTurnRate"].toDouble(),
    hpBarOffset: json["hpBarOffset"] == null ? null : json["hpBarOffset"],
    visionDaytimeRange: json["visionDaytimeRange"] == null ? null : json["visionDaytimeRange"],
    visionNighttimeRange: json["visionNighttimeRange"] == null ? null : json["visionNighttimeRange"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "attackType": attackType == null ? null : attackTypeValues.reverse[attackType],
    "startingArmor": startingArmor == null ? null : startingArmor,
    "startingMagicArmor": startingMagicArmor == null ? null : startingMagicArmor,
    "startingDamageMin": startingDamageMin == null ? null : startingDamageMin,
    "startingDamageMax": startingDamageMax == null ? null : startingDamageMax,
    "attackRate": attackRate == null ? null : attackRate,
    "attackAnimationPoint": attackAnimationPoint == null ? null : attackAnimationPoint,
    "attackAcquisitionRange": attackAcquisitionRange == null ? null : attackAcquisitionRange,
    "attackRange": attackRange == null ? null : attackRange,
    "primaryAttribute": primaryAttribute == null ? null : primaryAttributeValues.reverse[primaryAttribute],
    "heroPrimaryAttribute": heroPrimaryAttribute == null ? null : heroPrimaryAttribute,
    ...
    "visionDaytimeRange": visionDaytimeRange == null ? null : visionDaytimeRange,
    "visionNighttimeRange": visionNighttimeRange == null ? null : visionNighttimeRange,
